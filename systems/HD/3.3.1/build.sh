...
rm -rf $JAR_DIR/stax2-api-4.2.1.jar #   Newer Version causing issues with systems, use older
wget -P $JAR_DIR https://repo.maven.apache.org/maven2/org/codehaus/woodstox/stax2-api/3.1.4/stax2-api-3.1.4.jar 


rm -rf $JAR_DIR/jackson-databind-2.10.5.1.jar # Newer Version causing issues with systems, use older
wget -P $JAR_DIR https://repo1.maven.org/maven2/com/fasterxml/jackson/core/jackson-databind/2.9.9.2/jackson-databind-2.9.9.2.jar
