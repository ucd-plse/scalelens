...
#
# NameNode Metrics Logging (Fixed)
log4j.logger.org.apache.hadoop.hdfs.server.namenode=INFO, namenode
log4j.additivity.org.apache.hadoop.hdfs.server.namenode=false

log4j.appender.namenode=org.apache.log4j.RollingFileAppender
log4j.appender.namenode.File=${hadoop.log.dir}/hadoop-namenode.log
log4j.appender.namenode.MaxFileSize=100MB
log4j.appender.namenode.MaxBackupIndex=10
log4j.appender.namenode.layout=org.apache.log4j.PatternLayout
log4j.appender.namenode.layout.ConversionPattern=%d{ISO8601} %-5p %c{2} (%F:%L) - %m%n
...
#
datanode.metrics.logger=INFO, datanode
log4j.additivity.org.apache.hadoop.hdfs.server.datanode=false

log4j.appender.namenode=org.apache.log4j.RollingFileAppender
log4j.appender.namenode.File=${hadoop.log.dir}/hadoop-datanode.log
log4j.appender.namenode.MaxFileSize=100MB
log4j.appender.namenode.MaxBackupIndex=10
log4j.appender.namenode.layout=org.apache.log4j.PatternLayout
log4j.appender.namenode.layout.ConversionPattern=%d{ISO8601} %-5p %c{2} (%F:%L) - %m%n
...
# log4j.logger.org.apache.hadoop.mapred.ShuffleHandler.audit=INFO
...
#log4j.logger.org.apache.hadoop.yarn.server.resourcemanager.scheduler.fair.FairScheduler.statedump=INFO,FSSTATEDUMP
