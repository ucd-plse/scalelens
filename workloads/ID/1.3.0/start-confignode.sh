...
MAIN=org.apache.iotdb.confignode.service.ConfigNode
...
# flags for IoTDB confignode
CONFIGNODE_LOG_CONFIG="${NODE_CONF}/logback-confignode.xml"
CONFIGNODE_HOME="${NODE_BASE}"
CONFIGNODE_DATA_HOME="${NODE_DATA}"
CONFIGNODE_CONF="${NODE_CONF}"
CONFIGNODE_LOGS="${NODE_LOG}"
