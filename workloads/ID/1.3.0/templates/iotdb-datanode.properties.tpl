...
# Datatype: int
dn_rpc_port=@DN_RPC_PORT

# Used for communication inside cluster.
# could set 127.0.0.1(for local test) or ipv4 address.
# Datatype: String
dn_internal_address=@DN_IP

# Used for communication inside cluster.
# Bind with dn_internal_address
# Datatype: int
dn_internal_port=@DN_INTERNAL_PORT
...
# Bind with dn_internal_address
# Datatype: int
dn_schema_region_consensus_port=@DN_SCHEMA_REGION_CONSENSUS_PORT
...
# Datatype: String
dn_seed_config_node=@CN_IP:@CN_INTERNAL_PORT
