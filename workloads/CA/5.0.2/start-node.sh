...
if [ "$USE_AG" = "$B_TRUE" ]; then
  ...
  SL_AGENT_FLAGS="-Xbootclasspath/a:$AGENT_JAR:$AGENT_ASSIST"
...
# Add JVM module access overrides
  SL_AGENT_FLAGS="$SL_AGENT_FLAGS --add-opens java.base/jdk.internal.ref=ALL-UNNAMED"
  SL_AGENT_FLAGS="$SL_AGENT_FLAGS --add-opens java.base/java.nio=ALL-UNNAMED"
  SL_AGENT_FLAGS="$SL_AGENT_FLAGS --add-opens java.base/sun.nio.ch=ALL-UNNAMED"
  SL_AGENT_FLAGS="$SL_AGENT_FLAGS --add-opens java.management/sun.management=ALL-UNNAMED"
  SL_AGENT_FLAGS="$SL_AGENT_FLAGS --add-opens jdk.management/com.sun.management.internal=ALL-UNNAMED"
